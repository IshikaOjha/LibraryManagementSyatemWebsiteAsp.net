...
public partial class AddStudent : System.Web.UI.Page
{
    ...
    {
        //if (/*drpdd.SelectedIndex == 0 || drpmm.SelectedIndex == 0 || drpyyyy.SelectedIndex == 0*/ txtsbd.Text==0)
        //{
        ...
        //{
            ...
            if (FileUpload1.HasFile)
            {
                FileUpload1.SaveAs(Server.MapPath("~/img/") + FileUpload1.FileName);
                 DateTime dateTime = Convert.ToDateTime(txtsbd.Text);
                //DateTime bdate = Convert.ToDateTime(drpdd.SelectedItem.Text + " " + drpmm.SelectedItem.Text + " " + drpyyyy.SelectedItem.Text);
                SAdapter.Insert(txtsname.Text, drpbranch.SelectedItem.Text, txtmobile.Text, txtaddress.Text, txtcity.Text, txtpincode.Text, dateTime, /*txtsbd.Text,*/ /*bdate,*/ gen, txtemail.Text, txtpass.Text,"~/img/"+FileUpload1.FileName);
            ...
            else
            {
                DateTime dateTime = Convert.ToDateTime(txtsbd.Text);
                //DateTime bdate = Convert.ToDateTime(drpdd.SelectedItem.Text + " " + drpmm.SelectedItem.Text + " " + drpyyyy.SelectedItem.Text);
                SAdapter.Insert(txtsname.Text, drpbranch.SelectedItem.Text, txtmobile.Text, txtaddress.Text, txtcity.Text, txtpincode.Text, dateTime, /*txtsbd.Text,*/ /*bdate,*/ gen, txtemail.Text, txtpass.Text, "~/img/std.png");
                lblmsg.Text = "Student Added Successfully";
